...
namespace CrowdMorph
{
   ...
   public abstract unsafe class UpdateAnimatorSystemBase  : JobComponentSystem
   {
      ...
      JobHandle m_ClipEventProducerJobHandle;

      public JobHandle ClipEventProducerJobHandle
      {
         get => m_ClipEventProducerJobHandle;
      }
      ...
      {
         m_AnimationSystem.ClearClipEvents();
         ...
         foreach (var sharedAnimator in m_SharedAnimators)
         {
            ...
            var updateHandle = new UpdateAnimatorJob
            {
               ...
               AnimationContext = m_AnimationSystem.GetContext(),
         ...
         m_ClipEventProducerJobHandle = inputDeps;
         inputDeps = sharedSkeletons.Dispose(inputDeps);

         m_AnimationSystem.AddJobHandleForAnimationCommandProducer(inputDeps);
         return inputDeps;
      }
   }
}
